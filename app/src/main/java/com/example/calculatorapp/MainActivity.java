...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    List<String> mangLichSuTinhToan = new ArrayList<>();
    ...
    public void onClick(View view) {
        ...
        if(buttonText.equals("=")){
            String tinhtoan = solutionTv.getText().toString()+" = "+resultTv.getText().toString();
            mangLichSuTinhToan.add(tinhtoan);
            solutionTv.setText(resultTv.getText());
            return;
        }
        if(buttonText.equals("History")){
            Intent intent = new Intent(this,HistoryActivity.class);
            String[] array = (String[]) mangLichSuTinhToan.toArray(new String[mangLichSuTinhToan.size()]);
            intent.putExtra("dataHistory", array);
